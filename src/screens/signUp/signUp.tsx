    ...
    try {
      ...
      Alert.alert(
        ...
        [
          {
            text: "Continue",
            onPress: () => navigation.navigate("Onboarding", { screen: "AddMedia" } as never),
          },
        ],
        { cancelable: false }
      );
      ...
      <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.formArea}>
          ...
          <TouchableOpacity
            ...
            disabled={submitting}
          >
            <Text style={styles.primaryBtnText}>{submitting ? "Please wait..." : "Sign up"}</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
...
const styles = StyleSheet.create({
  ...
  brand: { fontSize: 16, color: "#6B7280", marginBottom: 4, textAlign: "center" },
